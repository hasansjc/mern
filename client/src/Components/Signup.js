            ...
            <div className="main_div">
                ...
                <div className="signup_container">
                    ...
                    <legend>Sign Up</legend>
                        ...
                        <br />
                        <input type="submit" value="Register" className="submit" onClick={postData} />
                        </fieldset>
                    </form>
                </div>
            </div>
